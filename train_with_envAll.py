...
def main(args):
    ...
    model_name = "PPO_P2A_All_" + "lr_" + str(args.sb3_lr) + "_timesteps_" + str(args.total_timesteps)
    ...
    model = PPO("CnnPolicy", env, verbose=1, n_steps = args.n_steps, learning_rate = args.sb3_lr)
